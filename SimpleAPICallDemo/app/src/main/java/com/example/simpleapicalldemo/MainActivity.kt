...
class MainActivity : AppCompatActivity() {
    ...
    private inner class CallAPILoginAsyncTask(val username: String, val password: String) :
        ...
        override fun doInBackground(vararg params: Any): String {
            ...
            try {
                val url = URL("https://run.mocky.io/v3/6ccc81c9-0c84-45c2-8deb-ab7abed442a9")
        ...
        override fun onPostExecute(result: String) {
            ...
            Log.i("JSON_Response_Result", result)
            ...
            for (item in 0 until dataListArray.length()) {
                ...
                // Returns the value mapped by {name} if it exists.
                val dataItemObject = dataListArray[item] as JSONObject
